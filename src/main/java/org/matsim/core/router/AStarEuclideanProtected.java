 ...
 * @author lnicolas
 */
public class AStarEuclideanProtected extends Dijkstra {
	 ...
	 * @param timeFunction
	 */
	AStarEuclideanProtected(final Network network, final PreProcessEuclidean preProcessData,
	 ...
	 * to return distance-minimal paths.
	 */
	AStarEuclideanProtected(final Network network,
