 ...
 * @author lnicolas
 */
public class AStarLandmarksProtected extends AStarEuclideanProtected {
	 ...
	 */
	AStarLandmarksProtected(final Network network, final PreProcessLandmarks preProcessData,
	 ...
	 * @param timeFunction Calculates the travel time on links.
	 */
	AStarLandmarksProtected(final Network network, final PreProcessLandmarks preProcessData, final TravelTime timeFunction) {
